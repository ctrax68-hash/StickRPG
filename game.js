...
window.allocChange = allocChange;

window.onContinue = () => {
if (loadGame()) launchGame(false);
else toast(‘Save corrupted — start a new game.’);
};
...
// Prevent pinch zoom globally - this is what breaks touch on iOS Safari
